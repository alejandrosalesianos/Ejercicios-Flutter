...
class FireEmblem extends StatefulWidget {
  const FireEmblem({Key? key}) : super(key: key);

  @override
  _FireEmblemState createState() => _FireEmblemState();
}

class _FireEmblemState extends State<FireEmblem> {
  ...
  Future<List<Amiibo>> fetchAmiibo() async {
    final response = await http.get(
        Uri.parse('https://www.amiiboapi.com/api/amiibo/?gameseries=0x210'));
